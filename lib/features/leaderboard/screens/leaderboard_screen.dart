...
class LeaderboardScreen extends StatelessWidget {
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      leading: Text('$rank', style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                      ...
                      onTap: () {
                        // TODO: Navigate to this user's public profile screen
                      },
                    );
                  },
                ),
  ...
  Widget _buildPodium(BuildContext context, List<LeaderboardEntry> topThree) {
    ...
    final podiumOrder = (topThree.length > 1) ? [topThree[1], topThree[0]] : topThree;
    ...
    return Container(
      ...
      child: Row(
        ...
        children: List.generate(podiumOrder.length, (index) {
          ...
          return _buildPodiumEntry(entry, rank);
        }),
      ),
    );
  }
  ...
  Widget _buildPodiumEntry(LeaderboardEntry entry, int rank) {
    final isFirst = rank == 1;
    final badgeColor = isFirst ? Colors.amber : (rank == 2 ? Colors.grey[400] : Colors.brown[300]);
        ...
        Stack(
          ...
          children: [
            CircleAvatar(
              radius: avatarSize,
              backgroundImage: entry.photoUrl.isNotEmpty ? NetworkImage(entry.photoUrl) : null,
              child: entry.photoUrl.isEmpty ? Icon(Icons.person, size: avatarSize) : null,
            ),
            Positioned(
              bottom: -5,
              right: -5,
